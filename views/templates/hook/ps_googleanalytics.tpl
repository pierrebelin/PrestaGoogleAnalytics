...
{/literal}
    ...
    {/if}
    {if isset($userId) && $userId && !$backOffice}
        ga('set', 'userId', '{$userId|escape:'htmlall':'UTF-8'}');
    {/if}
    {if isset($gaDisplayfeaturesEnabled) && $gaDisplayfeaturesEnabled}
        ga('require', 'displayfeatures');
    {/if}
    {if isset($gaAnonymizeEnabled) && $gaAnonymizeEnabled}
        ga('set', 'anonymizeIp', true);
    {/if}
    {if isset($backOffice) && $backOffice}
        ga('set', 'nonInteraction', true);
    {/if}
    {if isset($gaPageviewEnabled) && $gaPageviewEnabled}
        ga('send', 'pageview');
    {/if}
    {if isset($gaECEnabled) && $gaECEnabled}
        ga('require', 'ec');
    {/if}
{literal}
</script>
